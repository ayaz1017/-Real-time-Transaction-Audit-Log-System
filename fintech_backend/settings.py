...
SECRET_KEY = "django-insecure-q-^_959f-n5)&blj_&7r339@b#t9p-v9*x1q5mtwe=dr92+2j^"
...
INSTALLED_APPS = [
    ...
    # Local apps
    "core.apps.CoreConfig",  # use CoreConfig so ready() can seed demo accounts
]
...
# For production, restrict this to your actual frontend origin.
